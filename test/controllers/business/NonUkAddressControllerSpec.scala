...
import models.{NonUkAddress, NormalMode, TypeOfTrust, UserAnswers}
...
class NonUkAddressControllerSpec extends SpecBase with MockitoSugar {
  ...
  override val emptyUserAnswers: UserAnswers = UserAnswers("id", "UTRUTRUTR", LocalDate.now(), TypeOfTrust.WillTrustOrIntestacyTrust, None)
