$(document).ready(function() {
    ...
    if(document.querySelectorAll('select[data-non-uk-countries]').length > 0){
        ...
        var graphUrl = '/maintain-a-trust/settlors/assets/javascripts/autocomplete/location-non-uk-autocomplete-graph.json'
    ...
    if(document.querySelectorAll('select[data-all-countries]').length > 0){
        ...
        var graphUrl = '/maintain-a-trust/settlors/assets/javascripts/autocomplete/location-autocomplete-graph.json'
